...
public class SyncAccount extends TableImpl<SyncAccountRecord> {
    ...
    private static final long serialVersionUID = -255851391;
     ...
     */
    public final TableField<SyncAccountRecord, String> ADDRESS = createField("address", org.jooq.impl.SQLDataType.VARCHAR.length(45).nullable(false), this, "");
